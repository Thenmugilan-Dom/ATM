...
public class UserAction {
    ...
    public static Account login(ArrayList<Account> users, Scanner scanner) { // to login
    ...
    public static void depositAmt(Account user) { // to deposit
    ...
    public static void withdrawAmt(Account user) { // to withdraw
    ...
    public static void viewTransactions(Account user) { // view Transactions
