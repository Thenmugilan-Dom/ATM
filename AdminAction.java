...
public class AdminAction {
    public static Account login(ArrayList<Account> adminList, Scanner scanner) { // login method
    ...
    public static void addUser(Scanner scanner) { // add user
    ...
    public static void deleteUser(String id) { //delete user
    ...
    public static void viewAllAccounts() { // method to view all account
    ...
    public static void handleTransactionHistory(Account adminAccount, Scanner scanner) {
    ...
    private static void viewAdminTransactions(Account adminAccount) {
    ...
    private static void viewParticularUserTransactions(Scanner scanner) {
    ...
    public static void viewAllTransactions() { // view All Transactions
        ArrayList<User> users = ATM.getCustomerList();// array list of user
        for (User user : users) { // iterate all user
            System.out.println("Transactions for User: " + user.getId());
    ...
    public static void addATMoney(Account adminAccount, Scanner scanner) {
        if (!(adminAccount instanceof Admin)) {  // Check if the account is an admin.
